...
use ZnCore\Base\Libs\Arr\Libs\ArrayValues\ReplaceArrayValue;
use ZnCore\Base\Libs\Arr\Libs\ArrayValues\UnsetArrayValue;
...
abstract class BaseArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * // working with array
     * $type = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * $removed = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::removeValue($array, 'Jackson');
     * // result:
     ...
     * ];
     *
     * $result = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = \ZnCore\Base\Libs\Arr\Helpers\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
